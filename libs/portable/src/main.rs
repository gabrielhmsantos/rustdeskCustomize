...
const APP_PREFIX: &str = "infomaster";
...
mod windows {
    ...
    pub const WIN_TOPMOST_INJECTED_PROCESS_EXE: &'static str = "RuntimeBroker_infomaster.exe";
    ...
    pub(super) fn copy_runtime_broker(dir: &PathBuf) {
        ...
        let _allow_err = Command::new("taskkill")
            .args(&["/F", "/IM", "RuntimeBroker_infomaster.exe"])
